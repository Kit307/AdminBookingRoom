  ...
  >
    ...
    <div class="mb-4 px-4">
      ...
      <div
        ...
        @click="$router.replace('/admin/Detel')"
      >
        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          <path
    ...
    <div class="mb-4 px-4">
      ...
      >
        ...
        <span class="text-gray-700">Add Admin</span>
      </div>
    </div>
    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1">Link</p>
      ...
      >
        ...
        <span class="text-gray-700">Go to home page</span>
      </div>
    </div>
  </div>
